...
const allServices = [
    ...
    { id: 50, platform: 'Tiktok Paket FYP', name: 'Tiktok FYP V1', price: 98000, description: 'PAKET FYP V1 (200.000 View)(100.000 Like)(10.000 Share)(1.000 Save/Favorit)' },
    { id: 51, platform: 'Tiktok Paket FYP', name: 'Tiktok FYP V2', price: 50000, description: 'PAKET FYP V2 (100.000 View)(50.000 Like)(5.000 Share)(500 Save/Favorit)' },
    { id: 52, platform: 'Tiktok Paket FYP', name: 'Tiktok FYP V3', price: 30000, description: 'PAKET FYP V3 (50.000 View)(10.000 Like)(3.000 Share)(3.000 Save/Favorit)' },
    { id: 53, platform: 'Whatsapp', name: 'Whatsapp Channel Post Reaction [ 👍 ]', price: 20, description: '(Max 1K) (Instant)' },
    { id: 54, platform: 'Whatsapp', name: 'Whatsapp Channel Post Reaction [ ❤️ ]', price: 20, description: '(Max 1K) (Instant)' },
    { id: 55, platform: 'Whatsapp', name: 'Whatsapp Channel Post Reaction [ 😂 ]', price: 20, description: '(Max 1K) (Instant)' }, 
    { id: 56, platform: 'Whatsapp', name: 'Whatsapp Channel Post Reaction [ Mix 👍❤️😂😲😥🙏 ]', price: 20, description: '(Max 50K) (Instant)' },
    { id: 57, platform: 'Whatsapp', name: 'Whatsapp Channel Member', price: 36, description: '(Global)(Max 50K)(HQ Profiles)(500/days)' },
    { id: 58, platform: 'Telegram', name: 'Telegram Channel Group/Member', price: 21, description: '(Global)(Max 100K)(7 Days Refil)(25k/days)' },
    { id: 59, platform: 'Telegram', name: 'Telegram Post View', price: 21, description: '(Superfast)(Max 50m)(No Refil)' },
    { id: 60, platform: 'Telegram', name: 'Telegram Positive  Reaction (S1)(Mix👍 ❤️ 🔥 🎉🤩 😁 + Views)', price: 21, description: '(Max 200K)(10K/days)(No Refil)' },
    { id: 61, platform: 'Telegram', name: 'Telegram Story View', price: 21, description: '(HQ Services)(Max: 500K)(50K/days)(No Refil)' },
    { id: 62, platform: 'Google Maps', name: 'Rating Only', price: 6000, description: '(HQ Services)(Max: 500K)(50K/days)(No Refil)' },
    { id: 63, platform: 'Google Maps', name: 'Rating dan Ulasan', price: 8500, description: '(HQ Services)(Max: 500K)(50K/days)(No Refil)' },
    { id: 64, platform: 'Google Maps', name: 'Rating dan Foto', price: 19000, description: '(HQ Services)(Max: 500K)(50K/days)(No Refil)' },
];
